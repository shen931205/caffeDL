...
def split_HDF5_val_file(h5_path):
	...
	f1.create_dataset('data', (12871, 3, 256, 256), dtype=np.float32)
	f1.create_dataset('label', (12871, 10), dtype=np.float32)
	f2.create_dataset('data', (12872, 3, 256, 256), dtype=np.float32)
	f2.create_dataset('label', (12872, 10), dtype=np.float32)
	f3.create_dataset('data', (12872, 3, 256, 256), dtype=np.float32)
	...
	for ind in xrange(image_num):
		...
		elif ind >= 12871 and ind < 25742:
                        f2['data'][ind] = h5_file['data'][ind]
                        f2['label'][ind] = h5_file['label'][ind]
		else:
                        f3['data'][ind] = h5_file['data'][ind]
                        f3['label'][ind] = h5_file['label'][ind]
	...
	f3.close()
	h5_file.close()
	#print np.shape(f1['data']), np.shape(f2['data']), np.shape(f3['data'])
...
def split_HDF5_test_file(h5_path):
	...
	f10 = h5py.File(os.path.join(save_path, 'test10.h5'), 'w')
        ...
        f1.create_dataset('data', (5792, 3, 256, 256), dtype=np.float32)
	f1.create_dataset('label', (5792, 10), dtype=np.float32)
	f2.create_dataset('data', (5792, 3, 256, 256), dtype=np.float32)
	f2.create_dataset('label', (5792, 10), dtype=np.float32)
	f3.create_dataset('data', (5792, 3, 256, 256), dtype=np.float32)
	f3.create_dataset('label', (5792, 10), dtype=np.float32)
	f4.create_dataset('data', (5792, 3, 256, 256), dtype=np.float32)
	f4.create_dataset('label', (5792, 10), dtype=np.float32)
	f5.create_dataset('data', (5792, 3, 256, 256), dtype=np.float32)
	f5.create_dataset('label', (5792, 10), dtype=np.float32)
	f6.create_dataset('data', (5792, 3, 256, 256), dtype=np.float32)
	f6.create_dataset('label', (5792, 10), dtype=np.float32)
	f7.create_dataset('data', (5792, 3, 256, 256), dtype=np.float32)
	f7.create_dataset('label', (5792, 10), dtype=np.float32)
	f8.create_dataset('data', (5793, 3, 256, 256), dtype=np.float32)
	f8.create_dataset('label', (5793, 10), dtype=np.float32)
	
	f9.create_dataset('data', (5793, 3, 256, 256), dtype=np.float32)
	f9.create_dataset('label', (5793, 10), dtype=np.float32)
	f10.create_dataset('data', (5793, 3, 256, 256), dtype=np.float32)
...
def split_HDF5_train_file(h5_path):
	...
	f10 = h5py.File(os.path.join(save_path, 'train10.h5'), 'w')
        ...
        f1.create_dataset('data', (9653, 3, 256, 256), dtype=np.float32)
	f1.create_dataset('label', (9653, 10), dtype=np.float32)
	f2.create_dataset('data', (9653, 3, 256, 256), dtype=np.float32)
	f2.create_dataset('label', (9653, 10), dtype=np.float32)
	f3.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
	f3.create_dataset('label', (9654, 10), dtype=np.float32)
	f4.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
	f4.create_dataset('label', (9654, 10), dtype=np.float32)
	f5.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
	f5.create_dataset('label', (9654, 10), dtype=np.float32)
	f6.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
	f6.create_dataset('label', (9654, 10), dtype=np.float32)
	f7.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
	f7.create_dataset('label', (9654, 10), dtype=np.float32)
	f8.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
	f8.create_dataset('label', (9654, 10), dtype=np.float32)
	
	f9.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
	f9.create_dataset('label', (9654, 10), dtype=np.float32)
	f10.create_dataset('data', (9654, 3, 256, 256), dtype=np.float32)
